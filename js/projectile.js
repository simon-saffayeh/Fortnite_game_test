...
class Bullet {
  ...
  reset(origin, dir, opts) {
    ...
    if (isBomb)         { this.mat.color.setHex(0x111111); this.mesh.scale.setScalar(5); }
    else if (isGrenade) { this.mat.color.setHex(0x4a6622); this.mesh.scale.setScalar(3.5); }
    else { this.mat.color.setHex(this.faction === 'player' ? 0xffee44 : 0xff5522); this.mesh.scale.setScalar(1); }
