...
export class World {
  ...
  // GLTF furniture removed at user's request. Signature preserved so the
  // existing `await world.loadFurniture()` call in main.js still resolves
  // without churn; structures (walls, floors from _buildStructures) and
  // box-built props are unaffected.
  async loadFurniture() { /* no-op */ }
